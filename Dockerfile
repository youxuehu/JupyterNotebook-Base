...
RUN wget \
    https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/Miniconda3-4.3.27-Linux-x86_64.sh \
    && mkdir /root/.conda \
    && bash Miniconda3-4.3.27-Linux-x86_64.sh -b \
    && rm -f Miniconda3-4.3.27-Linux-x86_64.sh
RUN pip list
RUN conda  info

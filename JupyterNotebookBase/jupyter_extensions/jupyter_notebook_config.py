...
c.NotebookApp.nbserver_extensions = {  # noqa
    ...
    "JupyterNotebookBase.server_handler.get_handler": True,  # noqa
...
#  Choices: any of ['sha256', 'sha3_224', 'md5', 'sha3_384', 'blake2s', 'sha1', 'sha224', 'sha3_512', 'sha3_256', 'blake2b', 'sha384', 'sha512']
#  Default: 'sha256'
